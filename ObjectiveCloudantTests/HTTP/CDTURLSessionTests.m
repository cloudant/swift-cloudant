...
- (instancetype)init { return [self initWithNumberOfRetires:1]; }
...
@interface CDTURLSessionTests : XCTest
...
- (void)testInterceptorsSetCorrectly
{
    ...
    CDTInterceptableSession *session =
        [[CDTInterceptableSession alloc] initWithDelegate:nil
